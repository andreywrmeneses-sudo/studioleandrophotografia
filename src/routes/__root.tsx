...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Studio Leandro Photografia | Fotografia Profissional" },
      {
        name: "description",
        content:
      ...
      { name: "author", content: "Studio Leandro Photografia" },
      { property: "og:site_name", content: "Studio Leandro Photografia" },
